...
import 'package:hackathon/Functions/FirebaseFunction.dart';
...
import 'package:hackathon/Pages/groupChat/ChatPage.dart';
import 'package:hackathon/Pages/groupChat/CreateGroup.dart';
import 'package:hackathon/Provider/UserProvider.dart';
import 'package:hackathon/Utils/Constant.dart';
import 'package:hackathon/Utils/Drawer.dart';
import 'package:hackathon/Utils/Indicator.dart';
import 'package:hackathon/Utils/accountScrren.dart';
import 'package:hackathon/Utils/appBar.dart';
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: const TextStyle(
            ...
            color: Color.fromARGB(255, 255, 236, 143),
          ),
        ),
        centerTitle: true,
        actions: [
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          color: Color.fromARGB(255, 251, 235, 92),
        ),
        child: Column(
          children: [
            InkWell(
